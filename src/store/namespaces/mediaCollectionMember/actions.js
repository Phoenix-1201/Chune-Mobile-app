...
export const getTotalMediaCollectionMembers = async ({ state, effects }) => {
  ...
  state.mediaCollectionMembers.totalRecords = mediaCollectionMembers.length
}
...
export const getMediaCollectionMembers = async ({ state, effects }, data) => {
  ...
  state.mediaCollectionMembers.mediaCollectionMembers = _.keyBy(mediaCollectionMembers, 'id')
}
