...
declare module 'react-native-onesignal' {
  ...
  export interface OneSignal {
     ...
     */
    addEventListener(type: 'received', handler: (notification: ReceivedNotification) => void): void;
    addEventListener(type: 'opened', handler: (result: OpenResult) => void): void;
    addEventListener(type: 'ids', handler: (device: string) => void): void;

    /**
     * You can remove binded events with this function.
     */
    removeEventListener(type: 'received', handler: (notification: ReceivedNotification) => void): void;
    removeEventListener(type: 'opened', handler: (result: OpenResult) => void): void;
