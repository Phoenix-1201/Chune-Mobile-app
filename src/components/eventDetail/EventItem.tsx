...
import { MontBold, MontLight, MontRegular } from '../../controls/Text'
...
const StateText = styled(MontRegular)`
      font-size: 9px;
      line-height: 11px;
      font-weight: 600;
      color: #000000;
...
const CartNumber = styled(MontBold)`
    font-size: 14px;
    line-height: 17px;
    color: black;
`
